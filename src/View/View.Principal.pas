...
type
  TViewPrincipal = class(TForm)
    ...
    pnlLicençaInfo: TPanel;
    lbllicençaempresa: TLabel;
    Label1: TLabel;
...
//MUDANÇAS EM COR E INTERAÇÕES COM USUARIO ESTETICAS
    ...
    begin       //BARRA QUE FICA QUANDO CLICAMOS NAS OPÇÕES DO MENU
...
begin
    ...
    if Sender is TSpeedButton then
      TSpeedButton(Sender).Glyph.LoadFromFile('C:\Users\CBSistemas\Desktop\Delphiproject\Win32\Debug\Cliente-full.bmp'); // Caminho do ícone normal
end;

procedure TViewPrincipal.btnClientesMouseLeave(Sender: TObject);
begin
            if Sender is TSpeedButton then
        TSpeedButton(Sender).Glyph.LoadFromFile('C:\Users\CBSistemas\Desktop\Delphiproject\Win32\Debug\Cliente-outline.bmp') // Caminho do ícone de hover
end;
